...
public class Printing implements Printable {
    ...
    public Printing(String vehicle_Type, String user_Type, String slot_Number, String vehicle_Number, String InTime) {
    ...
    public int print(Graphics g, PageFormat pf, int pageIndex)
        ...
        Rectangle2D r = new Rectangle2D.Double(10, 10, 350, 420);
